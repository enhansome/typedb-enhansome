...
* [`Rasa`](https://github.com/RasaHQ/rasa) ⭐ 21,330 | 🐛 154 | 🌐 Python | 📅 2026-07-24 - Open-source machine learning framework to automate text-and voice-based conversations.
...
* [`TypeDB Studio - IDE for TypeDB`](https://github.com/vaticle/typedb-studio) ⭐ 232 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-11 - TypeDB Studio is an Integrated Development Environment for TypeDB for performing knowledge engineering.
* [`TypeDB OSI - Cyber Threat Intelligence`](https://github.com/typedb-osi/typedb-cti) ⭐ 171 | 🐛 0 | 🌐 Python | 📅 2026-01-08 - TypeDB CTI is an open source threat intelligence platform enabling threat intel professionals to bring together their disparate CTI information into one database
  and find new insights about cyber threats.
* [`Source++`](https://github.com/sourceplusplus/Assistant) ⭐ 92 | 🐛 13 | 🌐 Kotlin | 📅 2026-09-12 - Open-source automated programming assistant with runtime-aware and context-aware functionality.
...
* [`go-typeql`](https://github.com/CaliLuke/go-typeql) ⭐ 4 | 🐛 19 | 🌐 Go | 📅 2026-09-25 - A Go ORM for TypeDB 3.x with type-safe CRUD, query building, migrations, and code generation.
...
* [`TypeDB Driver Examples`](https://github.com/vaticle/typedb-driver-examples) ⭐ 84 | 🐛 8 | 🌐 HTML | 📅 2025-10-14 - This repository includes examples that showcase usage of TypeDB Drivers in reading from and writing to a TypeDB database.
...
* [`Julia`](https://github.com/Humans-of-Julia/TypeDBClient.jl) ⭐ 54 | 🐛 5 | 🌐 Julia | 📅 2022-03-30

## IDE and editor support

* [`Visual Studio Code - TypeQL Plugin`](https://github.com/typedb-osi/typeql-plugin-vscode) ⭐ 19 | 🐛 3 | 📅 2025-10-30
* [`JetBrains / IntelliJ - TypeQL Plugin`](https://github.com/typedb-osi/typeql-plugin-jetbrains) ⭐ 11 | 🐛 5 | 🌐 Kotlin | 📅 2026-02-13
* [`Emacs - TypeQL Plugin`](https://github.com/typedb-osi/typeql-plugin-emacs) ⭐ 7 | 🐛 1 | 🌐 Emacs Lisp | 📅 2025-08-03
