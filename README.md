...
* [`Rasa`](https://github.com/RasaHQ/rasa) ⭐ 21,322 | 🐛 154 | 🌐 Python | 📅 2026-07-24 - Open-source machine learning framework to automate text-and voice-based conversations.
...
* [`TypeDB Studio - IDE for TypeDB`](https://github.com/vaticle/typedb-studio) ⭐ 232 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-11 - TypeDB Studio is an Integrated Development Environment for TypeDB for performing knowledge engineering.
...
* [`TypeBridge`](https://github.com/ds1sqe/type-bridge) ⭐ 23 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - A modern, Pythonic ORM for TypeDB with an Attribute-based API that aligns with TypeDB's type system.
...
* [`Rust, Python, Java, Node.js and C`](https://github.com/vaticle/typedb-driver) ⭐ 67 | 🐛 76 | 🌐 Rust | 📅 2026-09-10
