...
* [`Rasa`](https://github.com/RasaHQ/rasa) ⭐ 21,294 | 🐛 153 | 🌐 Python | 📅 2026-07-24 - Open-source machine learning framework to automate text-and voice-based conversations.
...
* [`TypeDB Studio - IDE for TypeDB`](https://github.com/vaticle/typedb-studio) ⭐ 231 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-11 - TypeDB Studio is an Integrated Development Environment for TypeDB for performing knowledge engineering.
...
* [`Source++`](https://github.com/sourceplusplus/Assistant) ⭐ 92 | 🐛 13 | 🌐 Kotlin | 📅 2026-08-07 - Open-source automated programming assistant with runtime-aware and context-aware functionality.
...
* [`skills`](https://github.com/typedb/typedb-skills) ⭐ 12 | 🐛 1 | 📅 2026-07-29 - A collection of agent skills, including a TypeDB skill for agent workflows.
* [`go-typeql`](https://github.com/CaliLuke/go-typeql) ⭐ 4 | 🐛 18 | 🌐 Go | 📅 2026-08-12 - A Go ORM for TypeDB 3.x with type-safe CRUD, query building, migrations, and code generation.
...
* [`Rust, Python, Java, Node.js and C`](https://github.com/vaticle/typedb-driver) ⭐ 66 | 🐛 101 | 🌐 Rust | 📅 2026-08-14
