...
* [`Rasa`](https://github.com/RasaHQ/rasa) ⭐ 21,318 | 🐛 153 | 🌐 Python | 📅 2026-07-24 - Open-source machine learning framework to automate text-and voice-based conversations.
...
* [`TypeDB Studio - IDE for TypeDB`](https://github.com/vaticle/typedb-studio) ⭐ 232 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-28 - TypeDB Studio is an Integrated Development Environment for TypeDB for performing knowledge engineering.
